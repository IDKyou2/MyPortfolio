    ...
    <div class="w3-padding-large" id="main">
        ...
        <div class="w3-content w3-justify w3-text-grey w3-padding-64" id="about">
            ...
            <p>Hi! My name is Mark. A fourth year BSIT student from the University of Mindanao. Aspiring IT
                ...
                Passionate
                about creating innovative solutions and continuously learning to stay updated with the latest industry
                trends.
            </p>
            <h3 class="w3-padding-16 w3-text-light-grey">My Skills</h3>
            <p class="w3-wide">UI/UX</p>
            <div class="w3-white">
                <div class="w3-blue" style="height:28px;width:90%"></div>
            </div>
            <p class="w3-wide">Web Dev</p>
            <div class="w3-white">
                <div class="w3-yellow" style="height:28px;width:85%"></div>
            </div>
            <p class="w3-wide">Mobile Dev</p>
            <div class="w3-white">
                <div class="w3-red" style="height:28px;width:75%"></div>
            </div><br>
            ...
            <img src="/w3images/avatar_g2.jpg" alt="Avatar" class="w3-left w3-circle w3-margin-right"
                style="width:80px">
        ...
        <div class="w3-padding-64 w3-content w3-text-grey" id="contact">
            ...
            <div class="w3-section">
                ...
                <p><i class="fa fa-phone fa-fw w3-text-white w3-xxlarge w3-margin-right"></i> 09503859998</p>
                <p><i class="fa fa-envelope fa-fw w3-text-white w3-xxlarge w3-margin-right"> </i> Email: markterce0@gmail.com
                </p>
            </div><br>
        ...
        <footer class="w3-content w3-padding-64 w3-text-grey w3-xlarge">
            ...
            <p class="w3-medium">All rights reserved. <a href="#" target="_blank" class="w3-hover-text-green"> <text
                        id="year"></text></a>
                <!-- End footer -->
        </footer>
